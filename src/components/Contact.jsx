    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-gray-800 to-black p-4 text-white'>
        ...
        <div  className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/505b1da0-b88e-4a5b-b5ac-cd94afabb524" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mxx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's gossip</button>
                </form>
            </div>
        </div>
    </div>
